"use client"; // Necessário para o formulário e estados
            ...
            <div className="col-md-6">
              ...
              <form className="card" onSubmit={handleSubmit}>
                ...
                <div className="card-body">
                  ...
                  <div className="mb-3">
                    <label className="form-label required">Nível de Acesso</label>
                    <select
                    ...
                    >
                      {/* Opção nula para forçar a escolha e validar o estado */}
